  ...
  public: {
    Tables: {
      documentos_complementares: {
        ...
        Relationships: [
          {
            foreignKeyName: "documentos_complementares_sinistro_id_fkey"
            columns: ["sinistro_id"]
            isOneToOne: false
      ...
      imagens: {
        ...
        Relationships: [
          {
            foreignKeyName: "imagens_sinistro_id_fkey"
            columns: ["sinistro_id"]
            isOneToOne: false
            referencedRelation: "sinistros"
            referencedColumns: ["id"]
      ...
      testemunhas: {
        ...
        Relationships: [
          {
            foreignKeyName: "testemunhas_sinistro_id_fkey"
            columns: ["sinistro_id"]
            isOneToOne: false
            referencedRelation: "sinistros"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      is_authorized_personnel: { Args: { _user_id: string }; Returns: boolean }
    }
    Enums: {
